...
aws dynamodb create-table \
    ...
    --attribute-definitions AttributeName=PK,AttributeType=S AttributeName=SK,AttributeType=S AttributeName=LSI1SK,AttributeType=N AttributeName=GSI1PK,AttributeType=S AttributeName=GSI1SK,AttributeType=S \
